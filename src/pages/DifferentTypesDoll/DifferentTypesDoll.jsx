    ...
    <div className="differentDoll">
     ...
     data-aos-anchor-placement="bottom-bottom">
        ...
        <p className="text-center mt-2  ">
          ...
          modern dolls, <br />
          the most tender and realistic reborn babies, the most adorable fabric
          dolls, <br /> all the accessories you can imagine and much more.{" "}
        </p>
        <br />
      </div>
      <div className="gap-5 mb-4  differentDoll ">
        ...
        <img data-aos="zoom-in" src="https://i.ibb.co/bvC8Tn5/4.png" alt="" />
        <img data-aos="zoom-in" src="https://i.ibb.co/86M4W1t/5.png" alt="" />
...
export default DifferentTypesDoll;
